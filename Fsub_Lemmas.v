...
Proof with simpl_env; eauto using wf_typ_weaken_head, type_from_wf_typ, wf_cset_subst_tb,
  ...
  - Case "wf_typ_capt".
    ...
    (** This should probably go in another lemma, likely.  It's
        true though. *)
    inversion H; subst; inversion HwfC; subst...
    + unfold subst_cset...
      cset_split...
      constructor...
    ...
    + unfold subst_cset...
      cset_split; try rewrite cset_not_references_fvar_eq in H_destruct;
        try rewrite cset_references_fvar_eq in H_destruct;
        assert (NatSet.F.union {}N {}N = {}N) by (fnsetdec; eauto*); try rewrite H2;
        constructor; unfold allbound_typ; intros...
      * admit.
      * admit.
Admitted.
