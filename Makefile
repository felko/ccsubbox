...
Makefile.conf: 
	coq_makefile -o Makefile LibTactics.v AdditionalTactics.v Atom.v CaptureSets.v CoqIntro.v Environment.v Example.v FSetDecide.v FSetNotin.v FiniteSets.v Fsub_CVfacts.v Fsub_Definitions.v Fsub_Hints.v Fsub_Infrastructure.v Fsub_Lemmas.v Fsub_Soundness.v ListFacts.v Metatheory.v STLC_Solutions.v STLC_Tutorial.v Tactics.v
